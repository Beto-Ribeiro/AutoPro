...
export const ProductHead = styled.div`height:56px;background:#f4f5f7;padding:0 28px;display:grid;grid-template-columns:2fr 1fr .75fr .55fr;align-items:center;text-transform:uppercase;color:#455066;font-size:13px;font-weight:750;letter-spacing:.07em;border-bottom:1px solid ${border};@media(max-width:760px){display:none}`;
export const ProductRow = styled.button`
 width:100%;border:0;border-bottom:1px solid #e3d1d1;background:#fff;padding:25px 28px;display:grid;grid-template-columns:2fr 1fr .75fr .55fr;align-items:center;text-align:left;min-height:120px;transition:.15s;&:hover{background:#fffafa}.product{display:flex;align-items:center;gap:24px}.product>i{width:68px;height:68px;flex:0 0 68px;border:1px solid #d8d8d8;border-radius:10px;display:grid;place-items:center;background:linear-gradient(145deg,#39434f,#d2d7dc);color:#fff;font-size:30px;font-style:normal}.product strong{font-size:17px;font-weight:550}&>span>em{display:inline-block;padding:6px 9px;border-radius:5px;background:#efeeee;color:#66595b;font-size:12px;text-transform:uppercase;font-style:normal}&>b{font-size:16px}.stock{display:flex;align-items:center;gap:10px}.stock i{width:9px;height:9px;border-radius:50%}.green{background:#20bc62}.orange{background:#ff7817}.red{background:#dd4e58}@media(max-width:760px){grid-template-columns:1fr auto;gap:16px;padding:18px;&>span:nth-child(2),&>b{display:none}.product{gap:14px}.product strong{font-size:15px}.product>i{width:54px;height:54px;flex-basis:54px}}
`;
...
export const OrderHead = styled.div`height:58px;display:grid;grid-template-columns:1.15fr 2fr .95fr .95fr .9fr;align-items:center;gap:18px;padding:0 20px;color:#455066;text-transform:uppercase;font-size:12px;font-weight:750;letter-spacing:.06em;border-bottom:1px solid #ddd;@media(max-width:1050px){grid-template-columns:1fr 1.6fr .9fr .9fr;span:last-child{display:none}}@media(max-width:760px){display:none}`;
export const OrderRow = styled.div`
 min-height:98px;display:grid;grid-template-columns:1.15fr 2fr .95fr .95fr .9fr;align-items:center;gap:18px;padding:0 20px;border-bottom:1px solid #ddd;.client{display:flex;align-items:center;gap:12px}.client>i{width:40px;height:40px;flex:0 0 40px;display:grid;place-items:center;border-radius:50%;background:#dfe5fa;color:${slate};font-style:normal;font-weight:750}.client b,.client small{display:block}.client small{margin-top:4px;color:${slate};font-size:12px}time{color:${slate}}&>span:last-child em{font-style:normal;padding:7px 10px;border-radius:20px;background:#e1e4e8;font-size:12px}.enviado{background:#e2e8ff!important}.concluido{background:#e4f5e9!important;color:#27703d}@media(max-width:1050px){grid-template-columns:1fr 1.6fr .9fr .9fr;&>span:last-child{display:none}}@media(max-width:760px){grid-template-columns:1fr;gap:10px;padding:20px;&>strong{color:${red}}time,&>b{margin-left:52px}}
`;
